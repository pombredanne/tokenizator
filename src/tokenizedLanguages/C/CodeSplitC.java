 ...
 */
public class CodeSplitC implements TemplateCodeSplit{
// final definitions
    final String blockCommentStart = " " + "/" + "*";
    
    /**
     * Converts a С Source code sample into an array of strings where each
     * string contains the source code for each function.
            ...
            if(moustacheTotal == 0){
                ...
                if(mClosed > 0){
                    ...
                    if(lineStart >= lineEnd){
                        System.out.println("ERROR CSJ148 - Invalid C source code provided as input");
